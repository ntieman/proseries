!(function(e, t) {
  ...
  var h = (function(n) {
    ...
    function ae(t, e, n, i) {
      ...
      if (
        !i &&
        ((e ? e.ownerDocument || e : m) !== k && T(e), (e = e || k), S)
      ) {
        if (11 !== p && (l = Z.exec(t)))
          if ((o = l[1])) {
            if (9 === p) {
            ...
            } else if (u && (s = u.getElementById(o)) && y(e, s) && s.id === o)
              return n.push(s), n
          } else {
            ...
            if (
              ...
              return H.apply(n, e.getElementsByClassName(o)), n
          }
        if (
          f.qsa &&
          !E[t + ' '] &&
          ...
          if (((d = t), (u = e), 1 === p && X.test(t))) {
            for (
              ...
              c[r] = '#' + a + ' ' + we(c[r])
            ;(d = c.join(',')), (u = (ee.test(t) && ye(e.parentNode)) || e)
          }
          try {
          ...
          for (
            ...
            if (
              ...
              (i = l(
                ...
                (ee.test(r[0].type) && ye(t.parentNode)) || t
              ))
            ) {
      ...
      function(i, o) {
        C.fn[i] = function(e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (O[i] || C.uniqueSort(n), H.test(i) && n.reverse()),
            this.pushStack(n)
          )
        }
      }
          ...
          s = {
            ...
            then: function(t, n, i) {
              ...
              return C.Deferred(function(e) {
                r[0][3].add(c(0, e, m(i) ? i : M, e.notifyWith)),
                  r[1][3].add(c(0, e, m(t) ? t : M)),
                  r[2][3].add(c(0, e, m(n) ? n : I))
              }).promise()
            },
            promise: function(e) {
  ...
  function Ie(n, i, o, r) {
    ...
    var e,
      ...
      f = i[0],
      h = m(f)
    if (h || (1 < u && 'string' == typeof f && !y.checkClone && Le.test(f)))
  ...
  function ft(r, e, t) {
    ...
    for (
      ...
      if ((n = ft.prefilters[i].call(c, r, d, c.opts)))
        return (
          m(n.stop) &&
  ...
  ;(C.Animation = C.extend(ft, {
    ...
    tweener: function(e, t) {
      for (
        var n, i = 0, o = (e = m(e) ? ((t = e), ['*']) : e.match(q)).length;
        i < o;
        i++
      )
        (n = e[i]),
  ...
  C.extend(C.event, {
    trigger: function(e, t, n, i) {
      ...
      if (
        ...
        if (!i && !d.noBubble && !w(n)) {
          for (
            a = d.delegateType || f, Tt.test(a + f) || (r = r.parentNode);
            r;
            r = r.parentNode
          )
            p.push(r), (s = r)
  ...
  C.ajaxSetup({
    ...
    (y.createHTMLDocument = (((Yt = S.implementation.createHTMLDocument('')
    ...
    C.each(['top', 'left'], function(e, n) {
      C.cssHooks[n] = Ue(y.pixelPosition, function(e, t) {
        if (t) return (t = Be(e, n)), We.test(t) ? C(e).position()[n] + 'px' : t
      })
    }),
  ...
  return (
    (C.noConflict = function(e) {
      return k.$ === C && (k.$ = Jt), e && k.jQuery === C && (k.jQuery = Qt), C
    }),
    e || (k.jQuery = k.$ = C),
    C
  )
  ...
  $(function() {
    $('.showcase-list').slick({
      ...
      responsive: [
        ...
        { breakpoint: 899, settings: { slidesToShow: 1, slidesToScroll: 1 } }
      ]
    })
  }),
  $(function() {
      ...
      n = function() {
        ...
        t.each(function() {
          var e = $(this),
            ...
            i = t.height(),
            o = n + i,
            r = Math.max(35, Math.min(35 + o - s, i - 75))
          e.css('bottom', r + 'px')
        })
      }
    e.scroll(n),
