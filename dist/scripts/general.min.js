!(function(e, t) {
  ...
  var h = (function(n) {
    ...
    try {
      H.apply((t = O.call(y.childNodes)), y.childNodes),
    ...
    function se(t, e, n, r) {
      ...
      if (
        !r &&
        ((e ? e.ownerDocument || e : y) !== C && T(e), (e = e || C), E)
      ) {
        if (11 !== p && (u = Z.exec(t)))
          if ((i = u[1])) {
            if (9 === p) {
    ...
    function Ce(d, h, g, v, m, e) {
      return (
        ...
        le(function(e, t, n, r) {
          ...
          } else (p = Te(p === t ? p.splice(l, p.length) : p)), m ? m(null, t, p, r) : H.apply(t, p)
        })
      )
    }
    function Ee(e) {
  ...
  function we(e, t, n, r, i) {
    ...
    for (f.textContent = '', d = 0; (o = p[d++]); )
      if (r && -1 < k.inArray(o, r)) i && i.push(o)
        ...
        ((l = oe(o)), (a = ve(f.appendChild(o), 'script')), l && me(a), n)
      )
  ...
  function $e(e, t, n) {
    for (var r, i = t ? k.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || k.cleanData(ve(r)),
        r.parentNode &&
          (n && oe(r) && me(ve(r, 'script')), r.parentNode.removeChild(r))
    return e
  }
  k.extend({
  ...
  k.ajaxSetup({
    ...
    (m.createHTMLDocument = (((Vt = E.implementation.createHTMLDocument('')
      ...
      n = function() {
        ...
        t.each(function() {
          var e = $(this),
            ...
            r = t.height(),
            i = n + r,
            o = Math.max(35, Math.min(35 + i - a, r - 75))
          e.css('bottom', o + 'px')
        })
      }
    e.scroll(n),
